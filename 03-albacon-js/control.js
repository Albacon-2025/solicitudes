...
// xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// PARA MOSTRAR  ****************************
function mostrarAvisoControl() {
  div = document.getElementById('avisoControl');
  div.style.display = 'flex';
  document.getElementById('tituloAviso').innerHTML = tituloAviso;
  document.getElementById('mensajeAviso').innerHTML = mensajeAviso;
}
function mostrarAvisoVacioQR() {
  div = document.getElementById('mostrarAvisoVacioQR');
  div.style.display = 'flex';
  document.getElementById('tituloAvisoDos').innerHTML = tituloAvisoDos;
  document.getElementById('mensajeAvisoDos').innerHTML = mensajeAvisoDos;
}
// **************************************************************************************************************
// PARA CERRAR  ******************************
function cerrarAvisoControl() { // USADO PARA VALIDAR USUARIO CONTRASÑA VACIO
  div = document.getElementById('avisoControl');
  div.style.display = 'none';
    if(vigilante.value.length === 0 & contrasenia.value.length === 0){vigilante.focus();}
    if(vigilante.value.length != 0 & contrasenia.value.length === 0){contrasenia.focus();}
    return false;
}
/* --------  CERRAR AVISOS DE USUARIO Y CONTRASEÑA VACIOS  -----------------------  */
function cerrarAvisoValidacion() {
  var vigilante = document.getElementById('vigilante');
  var contrasenia = document.getElementById('contrasenia');
  div = document.getElementById('mostrarAvisoValidacion');
  div.style.display = 'none';
    if(vigilante.value.length === 0 & contrasenia.value.length === 0){vigilante.focus();}
...
/* --------  CERRAR AVISOS DE INPUT QR VACIO  -------------------------------------  */
function cerrarAvisoVacioQR() {
  var qr = document.getElementById('qr');
  div = document.getElementById('mostrarAvisoVacioQR');
  div.style.display = 'none';
    if(qr.value.length){qr.focus();}
    
    return false;
}
/* --------  CERRAR AVISOS DE INPUT QR NO HAY COINCIDENCIA  -----------------------  */
function cerrarAvisoNoCoincideQR() {
  var qr = document.getElementById('qr');
  div = document.getElementById('mostrarAvisoNoCoincideQR');
  div.style.display = 'none';
    if(qr.value.length){qr.focus();}
    return false;
}
...
function validarVigilante(){
  ...
  if(vigilante.value.length === 0){mostrarAvisoControl();return false;}
  if(vigilante.value.length != 0 & contrasenia.value.length == 0){mostrarAvisoControl();return false;}
